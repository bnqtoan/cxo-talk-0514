...
7. Bối cảnh công ty: quy mô (bao nhiêu người), giai đoạn, ngành, và các công cụ chính bạn đang dùng (CRM, kế toán, quản lý dự án, chat, tài liệu)?

SAU KHI TÔI XÁC NHẬN 7 Ô, làm 3 việc:

VIỆC 1 — Viết lại "BẢN MÔ TẢ VẤN ĐỀ" gọn gàng theo 7 ô trên (mỗi ô vài dòng). Đây là thứ tôi sẽ copy về.

VIỆC 2 — Đề xuất 2-3 HƯỚNG GIẢI khác nhau VỀ BẢN CHẤT. Ví dụ:
  - một hướng sửa QUY TRÌNH / TỔ CHỨC (đổi ai làm, làm khi nào, hoặc đổi động lực — không cần phần mềm)
  - một hướng MUA / CẤU HÌNH công cụ có sẵn (ít phải build)
  - một hướng DỰNG MÔI TRƯỜNG AI (không phải "dùng AI" chung chung, mà chỉ rõ: setup kiểu gì)
  Nếu cái giá của việc không làm gì (câu 5) là thấp, thêm hướng thứ tư: "Không làm gì — chấp nhận cái giá đó."
